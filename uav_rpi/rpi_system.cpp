 ...
 * rpi_system.cpp
 *
 *   Declares the Raspberry Pi system in the context of fluav. This class
 *   is in charge of configuring the sensors/actuators, the interfaces
 *   available, and the pilots (fly modes) allowed.
 *
